...
const MainNav = ({
  ...
  const routes = [
    ...
    {
      href: `/${params.storeId}/billboards`, //billboards tylko dla poszczególnego sklepu
      label: "Billboards",
      active: pathname === `/${params.storeId}/billboards`,
    },
    {
      href: `/${params.storeId}/categories`, //billboards tylko dla poszczególnego sklepu
      label: "Categories",
    ...
    {
      href: `/${params.storeId}/colors`, //billboards tylko dla poszczególnego sklepu
      label: "Colors",
